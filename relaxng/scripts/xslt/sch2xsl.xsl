...
<!-- DPC
    ...
    All modifications are marked with XML comments starting with " DPC".
...
<!-- DPC remove optimize param, add 
    attributes "true" | "false"
    only-child-elements "true" | "false"
    visit-text "true" "false"
-->
...
<!-- DPC omit title (Lars Huttar -->
	<xsl:apply-templates select="*[not(self::iso:ns or self::iso:title)]  "/>
</xsl:template>
